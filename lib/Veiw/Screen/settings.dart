            ...
            children: [
              Padding(
                ...
                child: CircleAvatar(
                  ...
                  child: Center(
                    child: Image.asset((controller.myServices.sharedPreferences.getString("gen")=="0")?ImgAsset.BoyImg:ImgAsset.GirlImg, height: 100),
                  ),
                ),
              ),
              Padding(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Get.to(const ResetPassVar(),transition: Transition.downToUp);
                      },
                      child: Container(
                        decoration: BoxDecoration(
                            color: const Color.fromARGB(163, 242, 242, 242),
